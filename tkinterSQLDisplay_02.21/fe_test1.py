...
root=Tk()
#root.configure(background='#ccebff')
...
s=1
for i in headings:
    # trv.column(i,minwidth=300, stretch=0)
    trv.heading(s, text=i)
    trv.column(s, anchor="c")
    s=s+1

#vsb = ttk.Scrollbar(wrapper1, orient="vertical", command=trv.yview)
#vsb.place(x=1500, y=95, height=200+20)

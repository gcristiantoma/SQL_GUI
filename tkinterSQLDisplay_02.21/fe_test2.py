...
wrapper1.grid(row=0,column=0,padx=0,pady=0,sticky='ew',ipady=10,ipadx=20)
# wrapper2.grid(row=1,column=0,padx=0,pady=0,rowspan=1,ipadx=900,columnspan=10)
wrapper3.grid(row=1,column=0,ipadx=0,ipady=200,rowspan=5)

trv=ttk.Treeview(wrapper1,columns=([i for i in range(1,6)]),show="headings",height="35")
trv.pack()
...
vsb.place(x=1900, y=5, height=400)
